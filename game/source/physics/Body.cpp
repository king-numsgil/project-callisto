...
namespace umbriel::physics
{
	...
	Corrade::Containers::Reference<BoxShape> Body::addBoxShape(f64 width, f64 height, f64 radius)
	{
	...
	Corrade::Containers::Reference<CircleShape> Body::addCircleShape(f64 radius, f64vec2 offset)
	{
	...
	Corrade::Containers::Reference<SegmentShape> Body::addSegmentShape(f64vec2 a, f64vec2 b, f64 radius)
	{
